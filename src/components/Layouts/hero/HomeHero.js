        ...
        <HeroWrapper bgImage={heroImage}>
            <div className="min-h-screen flex items-center">
              <div className="w-full max-w-7xl px-6 mt-16">
                ...
                <p className="text-xl md:text-2xl text-[#cc9445] uppercase tracking-widest"> 
            ...
            <button className="px-6 py-3 border border-white/30 rounded-xl hover:bg-[#c89b5c] transition mt-16">
               Book A Session
              </button>     
            </div>
            </div>
